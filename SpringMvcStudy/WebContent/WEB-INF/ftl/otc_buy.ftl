...
<head>
  ...
  <title>交易页面</title>
    <link rel="shortcut icon" href="/SpringMvcStudy/resource/images/images2/No_Smoking9.ico" type="image/x-icon">
...
<body>
  ...
  <div class="header-con">
    <div class="h-inner">
      ...
      <div class="nav">
        <a href="./otc" class="">首页</a><a href="./myproduct">我要转让</a><a href="./myAsset">我的账户</a>
      </div>   
