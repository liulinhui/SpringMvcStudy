...
public class TransPinYin {
	...
	private static TransPinYin chineseSpelling = new TransPinYin();
	public static TransPinYin getInstance() {
	...
	public static String trans2PinYin(String str) {
		return TransPinYin.getInstance().convertAll(str);
	}
	public static void main(String[] args) {
		long a=System.currentTimeMillis();
		String str = "元和供应123把你和我服务和访问非杀了";
		//String strPinYin = new TransPinYin().convertAll(str);
